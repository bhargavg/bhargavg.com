...
> Posts in this series: [JSON Parsing With Value Transformers](http://bhargavg.com/swift/2016/03/30/json-parsing-with-value-transformers.html), 
> [Parsing Arrays in JSON](http://bhargavg.com/swift/2016/04/05/parsing-arrays-in-json.html)
